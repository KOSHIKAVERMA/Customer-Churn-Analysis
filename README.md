...
- **Churn reasons**
  ...
  Once I understood the reasons behind customer churning, I explored how different variables in the data affected revenue and churn rate.
...
<br>
  ...
  from customers who had cancelled or downgraded their subscriptions in a given month. It's basically 
**monthly charges**.
